...
const ExamRadio = ({
  ...
  // 1.1 Get the correct answer (it might be hidden in the main question object but available in submission)
  // @ts-ignore
  const correctAnswer = (submission?.exam?.questions?.find((sq: any) => sq._id === q._id) as any)?.correctAnswer || q.correctAnswer;
